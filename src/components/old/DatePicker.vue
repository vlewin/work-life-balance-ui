<template>
  <div class="date-picker">
    <ul class="flex-container">
      <li class="flex-item label"><small>&laquo;</small></li>
      <li class="flex-item" v-for="date in dates" :class="{ selected: date === 5 }">
        {{ date }}
      </li>
      <li class="flex-item label"><small>&raquo;</small></li>
    </ul>
  </div>
</template>
